         ...
         <div class="row bg-title">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            <form class="form-horizontal form-material" id="add_user">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="email" min="1"  class="form-control form-control-line" placeholder="eg.$ 100" required="" id="email">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" min="1" id="name" placeholder="eg.50"
                                            class="form-control form-control-line" required=""> </div>
                                </div>
                                  <div class="form-group">
                                    <label class="col-md-12">Password</label>
                                    <div class="col-md-12">
                                        <input type="password" min="1" id="password" placeholder="eg.50"
                                            class="form-control form-control-line" required=""> </div>
                                </div>
                               <!--  <div class="form-group">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        <button class="btn btn-success" type="submit" id="add">Update Profile</button>
                                    </div>
                                </div>
                            </form>
                        </div>

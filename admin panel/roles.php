...
<a href="#" onclick="showRole()">
        ...
        <!-- /#page-wrapper -->
            ...
            <!-- The Modal -->
  <div class="modal fade" id="showRole">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
                                     <form class="form-horizontal form-material" id="add_roles">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text"  id="role" class="form-control form-control-line" placeholder="eg.edit" required="">
                                    </div>
                                </div>
                                 <div class="form-group">
                                    <label class="col-md-12">Permission</label>
                                    <div class="col-md-12" id="permission_select">
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <!-- Modal body -->
        <div class="modal-body">
                                     <form class="form-horizontal form-material" id="updateRole">
                                <!-- <div class="form-group">
                                    <label class="col-md-12">Full Name</label>
                                    <div class="col-md-12">
                                        <input type="text" placeholder="Johnathan Doe"
                                ...
                                <div class="form-group">
                                    <label class="col-md-12">Role</label>
                                    <div class="col-md-12">
                                        <input type="text"  id="edit_role" class="form-control form-control-line" placeholder="eg.edit" required="">
                                    </div>
                                </div>
                                 <div class="form-group">
                                    <label class="col-md-12">Permission</label>
                                    <div class="col-md-12" id="edit_permission_select">
